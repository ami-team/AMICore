...
public class QIdParser extends Parser {
	...
	public static class QIdContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).enterQId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).exitQId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QIdVisitor ) return ((QIdVisitor<? extends T>)visitor).visitQId(this);
	...
	public static class ConstraintQIdContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).enterConstraintQId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).exitConstraintQId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QIdVisitor ) return ((QIdVisitor<? extends T>)visitor).visitConstraintQId(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BasicQIdContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).enterBasicQId(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QIdListener ) ((QIdListener)listener).exitBasicQId(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QIdVisitor ) return ((QIdVisitor<? extends T>)visitor).visitBasicQId(this);
			else return visitor.visitChildren(this);
		}
	}
