...
//		LogSingleton.root.info("Hello World!");
		...
		CommandSingleton.executeCommand("BrowseQuery -catalog=\"self\" -entity=\"router_search_interface\" -sql=\"SELECT foo.id as bar FROM router_search_interface foo\"", false);
