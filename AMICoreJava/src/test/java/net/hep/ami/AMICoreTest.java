...
if(true)
{
		if (doCreateAndFill) {
			...
			try {
				...
				String values = "testxxxxxFILExxxxxsizexxxxx@NULLxxxxx" + Utility.escapeJavaString(jsonString) + "";
				String command = "AddElement -catalog=\"self\" -entity=\"router_field\" -separator=\"xxxxx\" -fields=\"" + fields + "\" -values=\"" + values + "\"";
				CommandSingleton.executeCommand(command, false);
			} catch (Exception e) {
				System.out.println(e.getMessage());
...
*/
		...
		*/
		...
		System.out.println("adding panda db");

		try {
			test_url = "jdbc:oracle:thin:@( DESCRIPTION= (ADDRESS= (PROTOCOL=TCP) (HOST=cman1-atlas.cern.ch) (PORT=10500)) (ADDRESS= (PROTOCOL=TCP) (HOST=cman2-atlas.cern.ch) (PORT=10500)) (ADDRESS= (PROTOCOL=TCP) (HOST=cman3-atlas.cern.ch) (PORT=10500)) (LOAD_BALANCE=on) (ENABLE=BROKEN) (CONNECT_DATA= (SERVER=DEDICATED) (SERVICE_NAME=adcr_panda.cern.ch)))";
			test_catalog = "ATLAS_AMI_PANDA_R";
			test_schema = "ATLAS_AMI_PANDA_R";
			test_user = "ATLAS_AMI_PANDA_R";
			test_pass = "rami4dpan";
			String fields = "externalCatalog;internalCatalog;internalSchema;jdbcUrl;user;pass;json";
			String values = "jedi;" + test_catalog + ";" + test_schema + ";" + test_url + ";" + test_user + ";" + test_pass + ";{}";
			String command = "AddElement -catalog=\"self\" -entity=\"router_catalog\" -separator=\";\" -fields=\"" + fields + "\" -values=\"" + values + "\"";
		...
		String commandTest2 = "BrowseQuery -catalog=\"jedi\" -entity=\"JEDI_TASKS\" -disallowBigContent -mql=\"SELECT JEDITASKID WHERE  JEDITASKID = '20508021' \"";

		System.out.println(commandTest2);
		try
		{
			System.out.println(CommandSingleton.executeCommand(commandTest2, false).replace(">", ">\n"));
			//CommandSingleton.executeCommand(commandTest, false);
		}
		catch(Exception e)
		{
