...
CREATE TRIGGER "trig1_FILE_TYPEE"
...
ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "pk1_DATASET_FILE_BRIDG" PRIMARY KEY ("id"),
  ADD CONSTRAINT "uk1_pk1_DATASET_FILE_BRIDG" UNIQUE ("datasetFK","fileFK"),
  ADD CONSTRAINT "fk1_DATASET_FILE_BRIDG" FOREIGN KEY ("datasetFK") REFERENCES "DATASET" ("id") ON DELETE CASCADE ON UPDATE NO ACTION,
