...
ALTER TABLE "FILE_TYPE"
  ADD CONSTRAINT "uk1_FILE_TYPE" UNIQUE ("name")
;;
...
ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "ck3_DATASET_FILE_BRIDGE" CHECK("datasetFK" IS NOT NULL)
;;

ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "ck4_DATASET_FILE_BRIDGE" CHECK("fileFK" IS NOT NULL)
;;

ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "ck5_DATASET_FILE_BRIDGE" CHECK("createdBy" IS NOT NULL)
;;

ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "ck6_DATASET_FILE_BRIDGE" CHECK("modified" IS NOT NULL)
;;

ALTER TABLE "DATASET_FILE_BRIDGE"
  ADD CONSTRAINT "ck7_DATASET_FILE_BRIDGE" CHECK("modifiedBy" IS NOT NULL)
;;
...
CREATE TRIGGER "trig1_DATASET_PARAMT"
