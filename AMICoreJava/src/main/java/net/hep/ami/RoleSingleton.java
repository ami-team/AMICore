...
public class RoleSingleton
{
	...
	public static boolean checkUser(@Nullable String validatorClass, @NotNull UserValidator.Mode mode, @NotNull String amiLogin, @NotNull String amiPassword, @Nullable String clientDN, @Nullable String issuerDN, @NotNull String firstName, @NotNull String lastName, @NotNull String email) throws Exception
	{
		if(Empty.is(validatorClass, Empty.STRING_NULL_EMPTY_BLANK))
		{
			return true;
		...
		return validator.check(mode, amiLogin, amiPassword, clientDN, issuerDN, firstName, lastName, email);
