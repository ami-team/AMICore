...
public class GenerateRevocationList extends AbstractCommand
{
	...
	public StringBuilder main(Map<String, String> arguments) throws Exception
	{
		...
		java.sql.ResultSet resultSet = getQuerier("self").executeSQLQuery(true, "SELECT `serial`, `reason`, `modified` FROM `router_authority` WHERE `reason` IS NOT NULL").getResultSet();
