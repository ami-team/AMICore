...
public class AddUserRole extends AbstractCommand
{
	...
	public AddUserRole(Set<String> userRoles, Map<String, String> arguments, long transactionId)
	{
	...
	public StringBuilder main(Map<String, String> arguments) throws Exception
	{
		...
		List<Row> rowList1 = querier.executeSQLQuery(true, "SELECT `id` FROM `router_user` WHERE `AMIUser` = ?", user).getAll();
