...
public class Router implements Querier
{
	...
	public void fill(@Nullable String schema) throws Exception
	{
		...
		executeSQLUpdate("INSERT INTO `router_catalog` (`externalCatalog`, `internalCatalog`, `internalSchema`, `jdbcUrl`, `user`, `pass`, `custom`, `archived`, `createdBy`, `modifiedBy`) VALUES (?, ?, ?, ?, ?, ?, ?, '0', 'admin', 'admin');",
			...
			"{\"router_authority\":{\"x\":10,\"y\":780,\"color\":\"#CCCC33\"},\"router_catalog\":{\"x\":270,\"y\":10,\"color\":\"#2BBB88\"},\"router_command\":{\"x\":10,\"y\":400,\"color\":\"#0066CC\"},\"router_command_role\":{\"x\":10,\"y\":290,\"color\":\"#0066CC\"},\"router_config\":{\"x\":10,\"y\":10,\"color\":\"#FF0000\"},\"router_converter\":{\"x\":10,\"y\":180,\"color\":\"#0066CC\"},\"router_entity\":{\"x\":530,\"y\":10,\"color\":\"#2BBB88\"},\"router_field\":{\"x\":790,\"y\":10,\"color\":\"#2BBB88\"},\"router_foreign_key\":{\"x\":790,\"y\":450,\"color\":\"#0066CC\"},\"router_ipv4_blocks\":{\"x\":270,\"y\":695,\"color\":\"#CCAC81\"},\"router_ipv6_blocks\":{\"x\":790,\"y\":700,\"color\":\"#CCAA88\"},\"router_locations\":{\"x\":530,\"y\":710,\"color\":\"#CCAA88\"},\"router_role\":{\"x\":270,\"y\":290,\"color\":\"#0066CC\"},\"router_search_interface\":{\"x\":270,\"y\":400,\"color\":\"#1494CC\"},\"router_short_url\":{\"x\":10,\"y\":560,\"color\":\"#0066CC\"},\"router_user\":{\"x\":530,\"y\":400,\"color\":\"#0066CC\"},\"router_user_role\":{\"x\":530,\"y\":290,\"color\":\"#0066CC\"}}"
		);
