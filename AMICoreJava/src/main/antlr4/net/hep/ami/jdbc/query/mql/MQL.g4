...
insertStatement
	: INSERT m_qIds=qIdTuple VALUES m_expressions=expressionTuple /*------------------------------*/ ('@' m_user=STRING)?
	;

updateStatement
	: UPDATE m_qIds=qIdTuple VALUES m_expressions=expressionTuple (WHERE m_expression=expressionOr)? ('@' m_user=STRING)?
	;
