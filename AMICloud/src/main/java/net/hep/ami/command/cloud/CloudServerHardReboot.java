...
public class CloudServerHardReboot extends CommandAbstractClass {
	/*---------------------------------------------------------------------*/
	...
	public CloudServerHardReboot(Map<String, String> arguments, int transactionID) {
	...
	public StringBuilder main() throws Exception {
		...
		try {
			cloud.hardRebootServer(m_region, m_serverID);
