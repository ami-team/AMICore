...
public class CloudRebuildServer extends CommandAbstractClass {
	/*---------------------------------------------------------------------*/
	...
	public CloudRebuildServer(Map<String, String> arguments, int transactionID) {
	...
	public StringBuilder main() throws Exception {
		...
		try {
			cloud.rebuildServer(m_region, m_serverID, m_imageID);
	...
	public static String help() {
		...
		return "Rebuild a server on the cloud.";
	}
	...
	public static String usage() {
		...
		return "(-endpoint=\"value\")? (-identity=\"value\")? (-credential=\"value\")? -region=\"value\" -serverID=\"value\" -imageID=\"value\"";
	}
